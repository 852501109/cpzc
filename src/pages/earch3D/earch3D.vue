...
<script setup>
  ...
  // 加载点材质纹理
  const starsTexture = new THREE.TextureLoader().load('@/assets/img/dkw.png');
  ...
  // 添加地球内外发光精灵
  let spriteTexture = new THREE.TextureLoader().load('@/assets/img/dkw.png');
  ...
  // 内发光
  let spriteTexture1 = new THREE.TextureLoader().load('@/assets/img/dkw.png');
  ...
  for (let i = 0; i < 30; i++) {
    // 实现光柱
    let lightPillarTexture = new THREE.TextureLoader().load('@/assets/img/dkw.png');
    ...
    let circleTexture = new THREE.TextureLoader().load('@/assets/img/dkw.png');
  ...
  // 创建月球环
  let moonRingTexture = new THREE.TextureLoader().load('@/assets/img/dkw.png');
